...
- [Transporte e Áudio](transport-and-audio.md) — WebSocket, rotas HTTP, fluxo de áudio, wake word
...
- [Estrutura do Repositório](repo-structure.md) — organização de pastas do Go module

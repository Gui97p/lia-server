...
type Store interface {
	Create(ctx context.Context, userID uuid.UUID, triggerType TriggerType, trustLevel auth.TrustLevel, conversationID uuid.UUID) (*Task, error)
	...
	LatestUserTask(ctx context.Context, userID uuid.UUID) (*Task, error)
